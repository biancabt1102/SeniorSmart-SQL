...
CREATE OR REPLACE FUNCTION FUNC_CALCULAR_DESCONTO_PLANO_ANUAL(V_CD_PLANO IN NUMBER, PERCENTUAL_DESCONTO IN NUMBER)
RETURN NUMBER 
IS
...
BEGIN
    DBMS_OUTPUT.PUT_LINE(FUNC_CALCULAR_DESCONTO_PLANO_ANUAL(V_CD_PLANO, V_PERCENTUAL_DE_DESCONTO));
END;
